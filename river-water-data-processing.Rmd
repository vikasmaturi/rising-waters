...
file_LA_contributions <- "~/Autumn-2019/COMM177b/rising-waters/LA_campaign_data_test.csv"
...
## Read in LA contribution data
```{r}
LA_contributions_test <- read_csv(file_LA_contributions)
